        ...
        <div className="skills-container">
          ...
          {selectedCategoryData && (
            <div className="relative">
                ...
                <div className="flex gap-0 overflow-x-auto scrollbar-hide">
                  {skillCategories.map((category, index) => (
                    ...
                    >
                      {/* Tab Background */}
                      <div className={`
                        relative px-4 py-3 sm:px-4 sm:py-2 md:px-6 md:py-3 transition-all duration-300 whitespace-nowrap
                        ${selectedCategory === category.id 
                          ? `${category.tabColor} text-white shadow-lg rounded-t-lg border-t border-l border-r border-transparent -mb-px` 
                          : 'bg-muted/80 text-muted-foreground border-t border-l border-r border-border hover:bg-muted hover:text-foreground rounded-t-lg -mb-px'
                        }
                      `}>
                        {/* Tab Content */}
              ...
              {/* Main Content Area */}
              <div className="bg-background/80 backdrop-blur-sm border border-border rounded-2xl rounded-tl-none rounded-tr-none sm:rounded-t-none p-4 sm:p-8 md:p-10 lg:p-12 shadow-xl relative z-10">
