        ...
        <div className="skills-container">
          ...
          {selectedCategoryData && (
            <div className="relative">
              ...
              {/* Main Content Area */}
              <div className="bg-background/80 backdrop-blur-sm border border-border rounded-b-2xl rounded-t-none p-4 sm:p-8 md:p-10 lg:p-12 shadow-xl relative z-10 mt-0">
