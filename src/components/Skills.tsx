...
<div className="relative z-20 mb-0 sm:mb-0">
  <div className="flex items-stretch overflow-x-auto scrollbar-hide h-10 sm:h-auto">
    {skillCategories.map((category) => (
      ...
      >
        {/* Tab Background (misma estética que antes) */}
        <div className={`
        ...
        `}>
          {/* Tab Content (idéntico a tu estilo) */}
          ...
          {/* Active Tab Connector (igual que antes, pero sin dejar hueco por el -mb-px de arriba) */}
          {selectedCategory === category.id && (
