...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contacto" className="contact-section py-12 sm:py-16 lg:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header */}
        <div className="text-center mb-6 sm:mb-12 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6">Contacto</h2>
          <p className="text-base sm:text-xl lg:text-2xl text-muted-foreground px-4 sm:px-0">¿Tienes una oportunidad o proyecto en mente? Estoy abierto a ello!</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 mb-8 sm:mb-12">
          ...
          >
            <div className="flex items-center space-x-3 sm:space-x-5">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-lg sm:text-2xl font-bold text-foreground group-hover:text-accent transition-colors duration-300 mb-1 sm:mb-2">Email</h3>
                <p className="text-sm sm:text-lg text-muted-foreground truncate">marcosbaezalopez@gmail.com</p>
                <p className="text-xs sm:text-base text-accent font-medium mt-1 sm:mt-2">Click para copiar correo</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center space-x-3 sm:space-x-5">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-lg sm:text-2xl font-bold text-foreground group-hover:text-green-500 transition-colors duration-300 mb-1 sm:mb-2">Teléfono</h3>
                <p className="text-sm sm:text-lg text-muted-foreground">+34 717 705 991</p>
                <p className="text-xs sm:text-base text-green-500 font-medium mt-1 sm:mt-2">Click para llamar</p>
              </div>
            </div>
          </div>

          {/* Location */}
          <div className="contact-card bg-background/80 backdrop-blur-sm border border-border rounded-xl p-5 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center space-x-3 sm:space-x-5">
              ...
              <div className="flex-1">
                <h4 className="text-lg sm:text-2xl font-bold text-foreground mb-1 sm:mb-2">Ubicación</h4>
                <p className="text-sm sm:text-lg text-muted-foreground">Madrid, España</p>
                <p className="text-xs sm:text-base text-purple-500 font-medium mt-1 sm:mt-2">Disponible para remoto</p>
              </div>
            </div>
          </div>
          ...
          <div className="contact-card bg-background/80 backdrop-blur-sm border border-border rounded-xl p-5 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center space-x-3 sm:space-x-5">
              ...
              <div className="flex-1">
                <h4 className="text-lg sm:text-2xl font-bold text-foreground mb-1 sm:mb-2">Estado</h4>
                <p className="text-sm sm:text-lg text-green-600 dark:text-green-400 font-medium">Disponible para entrevistas</p>
                <p className="text-xs sm:text-base text-muted-foreground mt-1 sm:mt-2">Respondo mensajes en menos de 24h</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
            ...
            >
              <div className="flex items-center space-x-3 sm:space-x-5">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-lg sm:text-2xl font-bold text-foreground group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300 mb-1 sm:mb-2">GitHub</h4>
                  <p className="text-sm sm:text-lg text-muted-foreground">Código fuente y proyectos</p>
                  <p className="text-xs sm:text-base text-gray-600 dark:text-gray-400 font-medium mt-1 sm:mt-2">Ver repositorios y contribuciones</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-center space-x-3 sm:space-x-5">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-lg sm:text-2xl font-bold text-foreground group-hover:text-blue-600 transition-colors duration-300 mb-1 sm:mb-2">LinkedIn</h4>
                  <p className="text-sm sm:text-lg text-muted-foreground">Conecta conmigo en LinkedIn</p>
                  <p className="text-xs sm:text-base text-blue-600 font-medium mt-1 sm:mt-2">Ir a mi perfil de LinkedIn</p>
                </div>
              </div>
            </a>
          </div>
